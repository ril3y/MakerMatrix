...
class TestDatasheetStandardization:
    ...
    def test_digikey_datasheet_url_standardization(self):
        ...
        digikey_result = PartSearchResult(
            ...
            additional_data={"digikey_part_number": "296-1234-ND", "rohs_status": "Compliant"},
        )

        # Map the result
        mapped_data = self.mapper.map_supplier_result_to_part_data(
            digikey_result, "DigiKey", ["get_part_details", "fetch_datasheet"]
        )
    ...
    def test_mouser_datasheet_url_standardization(self):
        ...
        mouser_result = PartSearchResult(
            ...
            additional_data={"mouser_part_number": "595-LM358", "lifecycle_status": "Active"},
        )

        # Map the result
        mapped_data = self.mapper.map_supplier_result_to_part_data(
            mouser_result, "Mouser", ["get_part_details", "fetch_datasheet"]
        )
        ...
        assert "datasheet_url" in mapped_data["additional_properties"]
        assert (
            mapped_data["additional_properties"]["datasheet_url"]
            == "https://www.mouser.com/datasheet/2/405/lm358-1234567.pdf"
        )
    ...
    def test_lcsc_datasheet_url_standardization(self):
        ...
        lcsc_result = PartSearchResult(
            ...
            category="Amplifiers",
            stock_quantity=2000,
            additional_data={"lcsc_part_number": "C7470", "package": "DIP-8", "is_smt": False},
        )

        # Map the result
        mapped_data = self.mapper.map_supplier_result_to_part_data(
            lcsc_result, "LCSC", ["get_part_details", "fetch_datasheet"]
        )
        ...
        assert (
            mapped_data["additional_properties"]["datasheet_url"]
            == "https://datasheet.lcsc.com/szlcsc/LM358P_C7470.pdf"
        )
    ...
    def test_datasheet_url_from_additional_data(self):
        ...
        result = PartSearchResult(
            ...
            additional_data={"lcsc_datasheet_url": "https://example.com/datasheet.pdf", "other_field": "value"},
        )

        # Map the result
        mapped_data = self.mapper.map_supplier_result_to_part_data(result, "TestSupplier", ["get_part_details"])
    ...
    def test_no_datasheet_url(self):
        ...
        result = PartSearchResult(
            ...
            datasheet_url=None,
            additional_data={"some_field": "value"},
        )
        ...
        assert (
            "datasheet_url" not in mapped_data["additional_properties"]
            or mapped_data["additional_properties"].get("datasheet_url") is None
        )
    ...
    def test_all_datasheet_key_variations(self):
        ...
        for key, expected_url in test_cases:
            result = PartSearchResult(
                ...
                description="Test",
                datasheet_url=None,
                additional_data={key: expected_url},
            )

            mapped_data = self.mapper.map_supplier_result_to_part_data(result, "TestSupplier", [])

            assert "datasheet_url" in mapped_data["additional_properties"]
            assert (
                mapped_data["additional_properties"]["datasheet_url"] == expected_url
