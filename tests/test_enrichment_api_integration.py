        ...
        with patch('MakerMatrix.routers.parts_routes.get_supplier', return_value=mock_supplier), \
            ...
            for key, value in additional_props.items():
                assert not isinstance(value, dict), \
                    f"additional_properties['{key}'] should not be a dict: {value}"
                assert not isinstance(value, list), \
                    f"additional_properties['{key}'] should not be a list: {value}"
        ...
        with patch('MakerMatrix.routers.parts_routes.get_supplier', return_value=mock_supplier), \
            ...
            for key, value in additional_props.items():
                assert not isinstance(value, (dict, list)), \
                    f"additional_properties['{key}'] contains nested data"
