...
class McMasterCarrSupplier(BaseSupplier):
    ...
    async def _setup_ssl_context(self) -> ssl.SSLContext:
        ...
        try:
            ...
            # Load client certificate
            cert_path = self._credentials.get("client_cert_path")
            cert_password = self._credentials.get("client_cert_password")
    ...
    async def test_connection(self) -> Dict[str, Any]:
        ...
        try:
            ...
            response = await self._make_api_request("/health")
    ...
    async def search_parts(self, query: str, limit: int = 50) -> List[PartSearchResult]:
        ...
        async def _impl():
            ...
            response = await self._make_api_request("/parts/search", params)
        ...
        try:
            return await self._tracked_api_call("search", _impl)
        except Exception as e:
