...
class HTTPResponse:
    ...
    def from_aiohttp_response(
        cls, response: aiohttp.ClientResponse, data: Dict[str, Any], duration_ms: int, raw_content: Optional[str] = None
    ):
    ...
    def error_response(cls, url: str, error_message: str, status: int = 500):
        ...
        return cls(
            status=status, data={}, headers={}, url=url, duration_ms=0, success=False, error_message=error_message
        )
...
class SupplierHTTPClient:
    ...
    async def _make_request_with_retry(self, method: str, url: str, endpoint_type: str, **kwargs) -> HTTPResponse:
        ...
        if not await self._check_rate_limits(endpoint_type):
            ...
            raise SupplierRateLimitError(
                f"Rate limit exceeded for {self.supplier_name}", supplier_name=self.supplier_name
            )
            ...
            try:
                ...
                async with session.request(method, url, **kwargs) as response:
                    ...
                    http_response = HTTPResponse.from_aiohttp_response(
                        response, data, duration_ms, raw_content=response_text
                    )
                    ...
                    await self._record_request(
                        ...
                        duration_ms=duration_ms,
                        metadata={"method": method, "url": url, "status": response.status, "attempt": attempt + 1},
                    )
                ...
                await self._record_request(
                    ...
                    duration_ms=duration_ms,
                    error_message=str(e),
                    metadata={"method": method, "url": url, "attempt": attempt + 1, "exception_type": type(e).__name__},
                )
    ...
    async def get(
        ...
        **kwargs,
        ...
        return await self._make_request_with_retry(
            "GET", url, endpoint_type, headers=request_headers, params=params, **kwargs
        )
    ...
    async def post(
        ...
        **kwargs,
        ...
        return await self._make_request_with_retry(
            "POST", url, endpoint_type, headers=request_headers, data=data, json=json_data, **kwargs
        )
    ...
    async def put(
        ...
        **kwargs,
        ...
        return await self._make_request_with_retry(
            "PUT", url, endpoint_type, headers=request_headers, data=data, json=json_data, **kwargs
        )

    async def delete(
        self, url: str, endpoint_type: str = "api_call", headers: Optional[Dict[str, str]] = None, **kwargs
    ) -> HTTPResponse:
        ...
        return await self._make_request_with_retry("DELETE", url, endpoint_type, headers=request_headers, **kwargs)
