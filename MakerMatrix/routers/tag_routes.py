...
async def create_tag(
    ...
    return BaseRouter.build_success_response(
        data=TagResponse.model_validate(created_tag),
...
async def get_tag(
    ...
    return BaseRouter.build_success_response(
        data=ResponseModel.model_validate(tag_data),
        message=service_response.message
    )
...
async def remove_tag_from_part(
    ...
    return BaseRouter.build_success_response(
        data={"tag_id": tag_id, "part_id": part_id},
        message=service_response.message
    )
...
async def remove_tag_from_tool(
    ...
    return BaseRouter.build_success_response(
        data={"tag_id": tag_id, "tool_id": tool_id},
        message=service_response.message
    )
