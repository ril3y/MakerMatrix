...
class BaseRouter:
    ...
    def build_success_response(
        ...
        return ResponseSchema(
            status="success", message=message, data=data, page=page, page_size=page_size, total_parts=total_parts
        )

    @staticmethod
    def build_error_response(message: str = "Operation failed", data: Any = None) -> ResponseSchema:
        """
        ...
        """
        return ResponseSchema(status="error", message=message, data=data)
                ...
                if current_user:
                    try:
                        ...
                        await activity_service.log_activity(
                            user_id=current_user.id, activity_type=activity_type, description=final_description
                        )
                    except Exception as e:
