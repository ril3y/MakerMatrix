...
class ResourceAlreadyExistsError(MakerMatrixException):
    ...
    def __init__(self, message: str, resource_type: Optional[str] = None, 
                 resource_id: Optional[str] = None, conflicting_field: Optional[str] = None):
...
class InvalidReferenceError(MakerMatrixException):
    ...
    def __init__(self, message: str, reference_type: Optional[str] = None, 
...
class SupplierConfigAlreadyExistsError(ResourceAlreadyExistsError):
    ...
    def __init__(self, message: str, supplier_name: Optional[str] = None):
        super().__init__(message, resource_type="supplier_config", 
                        conflicting_field="supplier_name")
        self.supplier_name = supplier_name
...
class PrinterConnectionError(ConnectionError):
    ...
    def __init__(self, message: str = "Cannot connect to printer", 
...
class InvalidLabelSizeError(PrinterError):
    ...
    def __init__(self, message: str, label_size: Optional[str] = None, 
                 printer_id: Optional[str] = None, supported_sizes: Optional[List[str]] = None):
