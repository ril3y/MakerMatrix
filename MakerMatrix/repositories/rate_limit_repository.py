...
class RateLimitRepository(BaseRepository[SupplierRateLimitModel]):
    ...
    def get_usage_counts(self, session: Session, supplier_name: str, 
                        time_windows: List[Tuple[datetime, str]]) -> Dict[str, int]:
        """
    ...
    def get_usage_summary(self, session: Session, supplier_name: str,
    ...
    def update_supplier_limits(self, session: Session, supplier_name: str, 
                             limits: Dict[str, int]) -> Optional[SupplierRateLimitModel]:
        """
