...
def create_single_price(price: float, currency: str = "USD", supplier: str = None) -> StandardPricing:
    ...
    return StandardPricing(
        pricing_type=PricingType.SINGLE_PRICE, unit_price=price, currency=currency, supplier=supplier
    )


def create_quantity_breaks(
    price_breaks: List[Dict[str, Any]], currency: str = "USD", supplier: str = None
) -> StandardPricing:
    """
