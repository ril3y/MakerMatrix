...
class TestDatabaseConfig:
    ...
    def create_test_engine(self, use_memory: bool = False) -> "Engine":
        ...
        self.test_engine = create_engine(test_sqlite_url, echo=False, connect_args={"check_same_thread": False})
...
def create_isolated_test_engine(use_memory: bool = False) -> "Engine":
    ...
    test_engine = create_engine(test_sqlite_url, echo=False, connect_args={"check_same_thread": False})
