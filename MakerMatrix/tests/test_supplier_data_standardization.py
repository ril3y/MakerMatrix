...
class TestSupplierDataStandardization:
    ...
    def test_part_model_ui_convenience_methods(self):
        ...
        expected_methods = [
            "get_display_name",
            "get_standardized_additional_properties",
            "get_specifications_dict",
            "get_supplier_data",
            "has_datasheet",
    ...
    def test_data_quality_scoring(self):
        ...
        minimal_part = PartModel(part_name="Minimal Part", quantity=1)
        ...
        print(
            f"✅ Data quality scoring: minimal={minimal_part.data_quality_score:.2f}, complete={complete_part.data_quality_score:.2f}"
        )
