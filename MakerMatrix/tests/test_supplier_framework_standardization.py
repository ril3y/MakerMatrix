...
1276-1000-1-ND,STM32F103C8T6,STMicroelectronics,ARM Cortex-M3 MCU 64KB Flash,3,$4.12,$12.36,REF001"""
    ...
    def test_mouser_uses_supplier_data_mapper(self, mouser_excel_sample_data, supplier_data_mapper):
        ...
        sample_part_data = {
            ...
            "quantity": 10,
            "supplier": "Mouser",
            "additional_properties": {"supplier_data": {"supplier": "Mouser"}, "order_info": {"unit_price": 0.84}},
        }
    ...
    def test_consistent_additional_properties_structure(self):
        ...
        mouser_data = {"part_number": "595-TLV9061IDCKR", "manufacturer": "Texas Instruments"}
        ...
        digikey_data = {"part_number": "296-6501-1-ND", "manufacturer": "Microchip Technology"}
    ...
    def test_smart_part_name_creation(self, unified_column_mapper):
        ...
        data_minimal = {"part_number": "C7442639"}
    ...
    def test_framework_wide_data_quality_validation(self, supplier_data_mapper):
        ...
        result = supplier_data_mapper.map_supplier_result_to_part_data(high_quality_data, "LCSC", ["csv_import"])

        # Should successfully map high quality data
        assert result is not None

        # Test minimal data
        minimal_data = {"part_number": "C7442639", "supplier": "LCSC"}

        result = supplier_data_mapper.map_supplier_result_to_part_data(minimal_data, "LCSC", ["csv_import"])
