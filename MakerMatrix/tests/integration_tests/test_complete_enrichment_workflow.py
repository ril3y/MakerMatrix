...
from MakerMatrix.services.system.enrichment_queue_manager import EnrichmentQueueManager
...
class TestCompleteEnrichmentWorkflow:
    ...
    async def test_queue_statistics(self, enrichment_queue_manager):
        ...
        await enrichment_queue_manager.queue_part_enrichment(
            part_id="stats-test-2", part_name="Stats Test Part 2", supplier_name="LCSC", capabilities=["fetch_image"]
        )
