...
class TestBrotherQLIntegration:
    ...
    async def test_brother_ql_with_service_qr_code(
        self, mock_socket, mock_convert, mock_send, printer_service_with_brother_ql, test_part
    ):
    ...
    @patch("MakerMatrix.printers.drivers.brother_ql.driver.convert")
    @patch("socket.create_connection")
    async def test_brother_ql_with_service_part_name(
        self, mock_socket, mock_convert, mock_send, printer_service_with_brother_ql, test_part
    ):
    ...
    @patch("MakerMatrix.printers.drivers.brother_ql.driver.convert")
    @patch("socket.create_connection")
    async def test_brother_ql_with_service_text_label(
        self, mock_socket, mock_convert, mock_send, printer_service_with_brother_ql
    ):
        ...
        result = await printer_service_with_brother_ql.print_text_label(
            "Integration Test Label", label_size="29", copies=2
        )
    ...
    @patch("MakerMatrix.printers.drivers.brother_ql.driver.convert")
    @patch("socket.create_connection")
    async def test_brother_ql_error_handling(
        self, mock_socket, mock_convert, mock_send, printer_service_with_brother_ql, test_part
    ):
