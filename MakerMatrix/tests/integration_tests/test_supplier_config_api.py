...
class TestSupplierConfigAPI:
    ...
    def test_create_supplier_success(self, auth_headers, sample_supplier_data):
        ...
        response = client.post("/api/config/suppliers", json=sample_supplier_data, headers=auth_headers)
    ...
    def test_create_lcsc_supplier(self, auth_headers, lcsc_supplier_data):
        ...
        response = client.post("/api/config/suppliers", json=lcsc_supplier_data, headers=auth_headers)
    ...
    def test_create_duplicate_supplier_error(self, auth_headers, sample_supplier_data):
        ...
        response1 = client.post("/api/config/suppliers", json=sample_supplier_data, headers=auth_headers)
        assert response1.status_code == 200

        # Try to create duplicate
        response2 = client.post("/api/config/suppliers", json=sample_supplier_data, headers=auth_headers)
    ...
    def test_create_case_insensitive_duplicate(self, auth_headers, lcsc_supplier_data):
        ...
        response1 = client.post("/api/config/suppliers", json=lcsc_supplier_data, headers=auth_headers)
        assert response1.status_code == 200
        ...
        response2 = client.post("/api/config/suppliers", json=lowercase_data, headers=auth_headers)
    ...
    def test_delete_supplier_success(self, auth_headers, sample_supplier_data):
        ...
        create_response = client.post("/api/config/suppliers", json=sample_supplier_data, headers=auth_headers)
        assert create_response.status_code == 200

        # Delete the supplier
        delete_response = client.delete("/api/config/suppliers/TESTSUPPLIER", headers=auth_headers)
    ...
    def test_delete_nonexistent_supplier(self, auth_headers):
        ...
        response = client.delete("/api/config/suppliers/NonExistentSupplier", headers=auth_headers)
    ...
    def test_delete_case_insensitive(self, auth_headers, lcsc_supplier_data):
        ...
        create_response = client.post("/api/config/suppliers", json=lcsc_supplier_data, headers=auth_headers)
        assert create_response.status_code == 200

        # Delete using lowercase name
        delete_response = client.delete("/api/config/suppliers/lcsc", headers=auth_headers)  # lowercase
    ...
    def test_create_supplier_validation_errors(self, auth_headers, invalid_data, expected_error):
        ...
        response = client.post("/api/config/suppliers", json=invalid_data, headers=auth_headers)
    ...
    def test_supplier_workflow_complete(self, auth_headers):
        ...
        create_response = client.post("/api/config/suppliers", json=supplier_data, headers=auth_headers)
        assert create_response.status_code == 200
        ...
        get_response = client.get("/api/config/suppliers/WORKFLOWTEST", headers=auth_headers)
        assert get_response.status_code == 200
        supplier_details = get_response.json()["data"]
        assert supplier_details["display_name"] == "Workflow Test Supplier"

        # Step 4: Delete supplier
        delete_response = client.delete("/api/config/suppliers/WORKFLOWTEST", headers=auth_headers)
        assert delete_response.status_code == 200
        ...
        get_deleted_response = client.get("/api/config/suppliers/WORKFLOWTEST", headers=auth_headers)
