...
class TestCSVImportLCSC:
    ...
    def test_lcsc_csv_preview(self, auth_headers, lcsc_csv_content):
        ...
        response = client.post("/api/csv/preview", json={"csv_content": lcsc_csv_content}, headers=auth_headers)
    ...
    def test_lcsc_csv_import_basic(self, auth_headers, lcsc_csv_content):
        ...
        response = client.post(
            ...
            json={
                ...
                "parser_type": "lcsc",
                "order_info": {"supplier": "LCSC", "order_number": "TEST-LCSC-001"},
            },
    ...
    def test_lcsc_csv_import_with_progress(self, auth_headers, lcsc_csv_content):
        ...
        response = client.post(
            ...
            json={
                "csv_content": lcsc_csv_content,
                "parser_type": "lcsc",
                "order_info": {"supplier": "LCSC", "order_number": "TEST-LCSC-PROGRESS"},
            },
            headers=auth_headers,
        )
    ...
    def test_lcsc_specific_parts_import(self, auth_headers, lcsc_csv_content):
        ...
        response = client.post(
            ...
            json={
                "csv_content": lcsc_csv_content,
                "parser_type": "lcsc",
                "order_info": {"supplier": "LCSC", "order_number": "TEST-LCSC-SPECIFIC"},
            },
            headers=auth_headers,
        )
        ...
        response = client.get(
            "/api/parts/search_text", params={"query": "VEJ101M1VTT-0607L", "page_size": 50}, headers=auth_headers
        )
    ...
    def test_lcsc_csv_parser_info(self, auth_headers):
        ...
        response = client.get("/api/csv/parsers/lcsc/info", headers=auth_headers)
...
class TestCSVImportDigiKey:
    ...
    def test_digikey_csv_preview(self, auth_headers, digikey_csv_content):
        ...
        response = client.post("/api/csv/preview", json={"csv_content": digikey_csv_content}, headers=auth_headers)
    ...
    def test_digikey_csv_import_basic(self, auth_headers, digikey_csv_content):
        ...
        response = client.post(
            ...
            json={
                ...
                "parser_type": "digikey",
                "order_info": {"supplier": "DigiKey", "order_number": "88269818"},
            },
            headers=auth_headers,
        )
    ...
    def test_digikey_specific_parts_import(self, auth_headers, digikey_csv_content):
        ...
        response = client.post(
            ...
            json={
                "csv_content": digikey_csv_content,
                "parser_type": "digikey",
                "order_info": {"supplier": "DigiKey", "order_number": "DK-TEST-001"},
            },
            headers=auth_headers,
        )
        ...
        # Check that parts were created by searching for them
        response = client.get(
            "/api/parts/search_text", params={"query": "TXB0108PWR", "page_size": 50}, headers=auth_headers
        )
    ...
    def test_digikey_csv_parser_info(self, auth_headers):
        ...
        response = client.get("/api/csv/parsers/digikey/info", headers=auth_headers)
...
class TestCSVImportEdgeCases:
    ...
    def test_empty_csv_content(self, auth_headers):
        ...
        response = client.post("/api/csv/preview", json={"csv_content": ""}, headers=auth_headers)
    ...
    def test_invalid_csv_format(self, auth_headers):
        ...
        response = client.post("/api/csv/preview", json={"csv_content": invalid_csv}, headers=auth_headers)
    ...
    def test_unsupported_parser_type(self, auth_headers, lcsc_csv_content):
        ...
        response = client.post(
            ...
            json={
                ...
                "order_info": {"supplier": "Test", "order_number": "TEST-001"},
            },
            headers=auth_headers,
        )
    ...
    def test_csv_import_without_auth(self, lcsc_csv_content):
        ...
        response = client.post(
            ...
            json={
                "csv_content": lcsc_csv_content,
                "parser_type": "lcsc",
                "order_info": {"supplier": "LCSC", "order_number": "TEST-001"},
            },
        )
    ...
    def test_csv_enrichment_task_creation(self, auth_headers, lcsc_csv_content):
        ...
        import_response = client.post(
            ...
            json={
                "csv_content": lcsc_csv_content,
                "parser_type": "lcsc",
                "order_info": {"supplier": "LCSC", "order_number": "ENRICHMENT-TEST"},
            },
            headers=auth_headers,
        )
        ...
        response = client.post(
            ...
            json={"supplier": "LCSC", "csv_content": lcsc_csv_content, "order_number": "ENRICHMENT-TEST"},
            headers=auth_headers,
        )
    ...
    def test_bulk_enrichment_after_import(self, auth_headers, lcsc_csv_content):
        ...
        import_response = client.post(
            ...
            json={
                "csv_content": lcsc_csv_content,
                "parser_type": "lcsc",
                "order_info": {"supplier": "LCSC", "order_number": "BULK-ENRICHMENT-TEST"},
            },
            headers=auth_headers,
        )
        ...
        parts_response = client.get(
            "/api/parts/search_text", params={"query": "LCSC", "page_size": 50}, headers=auth_headers
        )
        ...
        if parts_response.status_code == 200 and parts_response.json().get("data"):
            ...
            if parts:
                ...
                response = client.post(
                    ...
                    json={"part_ids": part_ids, "supplier": "LCSC", "capabilities": ["fetch_datasheet", "fetch_image"]},
                    headers=auth_headers,
                )
...
class TestCSVImportConfiguration:
    ...
    def test_get_csv_config(self, auth_headers):
        ...
        response = client.get("/api/csv/config", headers=auth_headers)
    ...
    def test_update_csv_config(self, auth_headers):
        ...
        response = client.put("/api/csv/config", json=new_config, headers=auth_headers)
        ...
        get_response = client.get("/api/csv/config", headers=auth_headers)
    ...
    def test_get_supported_csv_types(self, auth_headers):
        ...
        response = client.get("/api/csv/supported-types", headers=auth_headers)
...
C60633,SWPA6045S101MT,Sunlord,,-,50,0.0715"""
        ...
        response = client.post(
            ...
            json={
                ...
                "parser_type": "lcsc",
                "order_info": {"supplier": "LCSC", "order_number": "MIXED-DATA-TEST"},
            },
            headers=auth_headers,
        )
    ...
    def test_import_progress_tracking(self, auth_headers, lcsc_csv_content):
        ...
        response = client.post(
            ...
            json={
                "csv_content": lcsc_csv_content,
                "parser_type": "lcsc",
                "order_info": {"supplier": "LCSC", "order_number": "PROGRESS-TEST"},
            },
            headers=auth_headers,
        )
        ...
        progress_response = client.get("/api/csv/import/progress", headers=auth_headers)
...
class TestCSVTaskIntegration:
    ...
    def test_csv_import_creates_tasks(self, auth_headers, lcsc_csv_content):
        ...
        response = client.post(
            ...
            json={
                "csv_content": lcsc_csv_content,
                "parser_type": "lcsc",
                "order_info": {"supplier": "LCSC", "order_number": "TASK-INTEGRATION-TEST"},
            },
            headers=auth_headers,
        )
        ...
        tasks_response = client.get("/api/tasks/", params={"limit": 50}, headers=auth_headers)
    ...
    def test_task_capabilities_for_csv_suppliers(self, auth_headers):
        ...
        lcsc_response = client.get("/api/tasks/capabilities/suppliers/LCSC", headers=auth_headers)

        # Should either have capabilities or return 404
        assert lcsc_response.status_code in [200, 404]

        # Check DigiKey capabilities
        dk_response = client.get("/api/tasks/capabilities/suppliers/DigiKey", headers=auth_headers)
