...
class TestRealServerComprehensive:
    ...
    def lcsc_test_data(self) -> Dict[str, Any]:
        ...
        test_data_path = Path(
            "/home/ril3y/MakerMatrix/MakerMatrix/tests/csv_test_data/LCSC_Exported__20241222_232708.csv"
        )
    ...
    def test_system_counts(self, real_server: RealServerTestHelper):
        ...
        print(
            f"✅ System counts - Parts: {counts['parts']}, Locations: {counts['locations']}, Categories: {counts['categories']}"
        )
    ...
    def test_csv_import_real_data(self, real_server: RealServerTestHelper, lcsc_test_data: Dict[str, Any]):
        ...
        response = real_server.test_csv_import(
            csv_file_path=lcsc_test_data["csv_file"], supplier_name=lcsc_test_data["supplier_name"]
        )
    ...
    def test_database_integrity_real_server(self, real_server: RealServerTestHelper):
        ...
        print(
            f"✅ Database integrity maintained: {initial_data['parts']} → {mid_data['parts']} → {final_data['parts']}"
        )
    ...
    def test_error_handling_real_server(self, real_server: RealServerTestHelper):
        ...
        invalid_part = {"part_name": "", "quantity": "invalid"}  # Invalid empty name  # Invalid quantity type
