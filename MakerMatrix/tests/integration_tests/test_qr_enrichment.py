...
class TestQREnrichmentIntegration:
    ...
    def test_part_create_schema_default_values(self):
        ...
        part_data = {"part_name": "Test Part", "quantity": 1}
    ...
    def test_qr_part_creation_supplier_not_configured(
        self, mock_supplier_config, mock_available_suppliers, client, auth_headers, sample_qr_part_data
    ):
    ...
    def test_part_create_validation_with_enrichment(self):
        ...
        with pytest.raises(ValueError, match="Either part_name or part_number must be provided"):
            PartCreate(quantity=1, auto_enrich=True, enrichment_supplier="LCSC")

        # Should work with part_name
        part = PartCreate(part_name="Test Part", quantity=1, auto_enrich=True, enrichment_supplier="LCSC")
        assert part.part_name == "Test Part"

        # Should work with part_number
        part = PartCreate(part_number="TEST123", quantity=1, auto_enrich=True, enrichment_supplier="LCSC")
