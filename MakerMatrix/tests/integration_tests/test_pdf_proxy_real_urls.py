...
class TestPDFProxyRealURLs:
    ...
    def test_digikey_domain_allowed(self):
        ...
        digikey_urls = ["https://digikey.com/en/datasheets/test.pdf", "https://www.digikey.com/en/datasheets/test.pdf"]
    ...
    def test_mouser_domain_allowed(self):
        ...
        mouser_urls = ["https://mouser.com/pdfdocs/test.pdf", "https://www.mouser.com/pdfdocs/test.pdf"]
