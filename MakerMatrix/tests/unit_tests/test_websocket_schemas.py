...
class TestWebSocketEventType:
    ...
    def test_all_event_types_defined(self):
        ...
        expected_types = [
            "ping", "pong", "error", "connection_status",
            "import_started", "import_progress", "import_completed", "import_failed",
            "enrichment_started", "enrichment_progress", "enrichment_completed", "enrichment_failed",
            "rate_limit_update", "rate_limit_warning", "rate_limit_exceeded",
            "task_created", "task_updated", "task_completed", "task_failed",
            "supplier_status_changed", "supplier_error",
            "notification", "toast"
        ]
...
class TestNotificationData:
    ...
    def test_notification_without_actions(self):
        ...
        data = NotificationData(
            ...
            message="Approaching rate limit for MOUSER"
        )
...
class TestToastData:
    ...
    def test_valid_toast_data(self):
        ...
        data = ToastData(
            level="success",
            message="Part enrichment completed",
            duration=4000,
...
@pytest.mark.parametrize("event_type,expected_string", [
