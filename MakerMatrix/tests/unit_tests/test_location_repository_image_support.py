...
class TestLocationRepositoryImageSupport:
    ...
    def test_update_location_add_image_url(self):
        ...
        location_data = {"name": "Location to Update", "description": "Will add image", "location_type": "drawer"}
    ...
    def test_get_all_locations_includes_image_urls(self):
        ...
        locations_data = [
            ...
            {"name": "Location 2 without Image", "description": "No image", "location_type": "drawer"},
            {
        ...
        for location in all_locations:
            if (
                ...
                and "with Image" in location.name
                or "without Image" in location.name
            ):
