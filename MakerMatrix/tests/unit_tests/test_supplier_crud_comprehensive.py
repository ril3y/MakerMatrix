...
class TestSupplierCRUDOperations:
    ...
    def test_supplier_registry_operations(self):
        ...
        class TestSupplier(BaseSupplier):
            def get_supplier_info(self) -> SupplierInfo:
                return SupplierInfo(
                    name="test_supplier", display_name="Test Supplier", description="Test supplier for CRUD testing"
                )
    ...
    def test_supplier_configuration_create(self):
        ...
        with patch("MakerMatrix.services.system.supplier_config_service.Session") as mock_session_class:
            ...
            with patch(
                "MakerMatrix.services.system.supplier_config_service.SupplierConfigModel", return_value=mock_config
            ):
    ...
    def test_supplier_configuration_validation(self):
        ...
        valid_config = {"rate_limit_per_minute": 20, "timeout_seconds": 30, "max_retries": 3}
        ...
        if config_options:
            ...
            invalid_config = {"rate_limit_per_minute": "invalid_number", "timeout_seconds": -1}
