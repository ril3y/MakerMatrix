...
from MakerMatrix.printers.base import (
    BasePrinter, PrinterInfo, PrinterCapability, PrinterStatus, 
    PrintJobResult, PrinterNotFoundError, PrinterError
)
...
class TestPrinterCRUDOperations:
    ...
    def test_printer_status_management(self):
        ...
        status_printer = MockPrinter(
            printer_id="status_test_printer",
    ...
    def test_printer_queue_management(self):
        ...
        queue_printer = MockPrinter(
            printer_id="queue_test_printer",
    ...
    def test_printer_settings_persistence(self):
        ...
        settings_printer = MockPrinter(
            printer_id="settings_test_printer",
            name="Settings Test Printer",
            model="Brother QL-800"
        )
    ...
    def test_printer_error_handling(self):
        ...
        error_printer = MockPrinter(
            printer_id="error_test_printer",
            name="Error Test Printer",
    ...
    def test_printer_connection_management(self):
        ...
        connection_types = [
            {
                "type": "USB",
                "config": {"device_path": "/dev/usb/lp0", "baud_rate": 9600}
            },
            {
                "type": "Network",
                "config": {"ip_address": "192.168.1.71", "port": 9100}
            },
            {
                "type": "Bluetooth",
                "config": {"mac_address": "00:11:22:33:44:55", "channel": 1}
            }
        ]
    ...
    def test_printer_performance_metrics(self):
        ...
        perf_printer = MockPrinter(
            printer_id="performance_test_printer",
    ...
    def test_printer_bulk_operations(self):
        ...
        for i in range(10):
            printer = MockPrinter(
                printer_id=f"bulk_printer_{i:02d}",
                name=f"Bulk Printer {i:02d}",
                model="Brother QL-800"
            )
