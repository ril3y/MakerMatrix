...
class TestLabelPreviewAndPrinting:
    ...
    def test_label_template_creation(self):
        ...
        qr_template = self.preview_service.create_qr_label_template(
            data="https://example.com/part/C7442639",
            label_size="29x90",
            qr_size=100
        )
        ...
        combined_template = self.preview_service.create_combined_label_template(
            qr_data="https://example.com/part/C7442639",
            text="C7442639",
            label_size="62x29"
        )
    ...
    def test_label_size_management(self):
        ...
        for size in standard_sizes:
            ...
            preview = self.preview_service.generate_text_label_preview(
                text=f"Test {size}",
                label_size=size
            )
    ...
    def test_qr_code_generation_options(self):
        ...
        # Test basic QR code
        basic_qr = self.preview_service.generate_qr_code(
            data="https://example.com/part/C7442639"
        )
        ...
        for size in qr_sizes:
            sized_qr = self.preview_service.generate_qr_code(
                data="Test QR Data",
                qr_size=size
            )
        ...
        for level in error_levels:
            error_qr = self.preview_service.generate_qr_code(
        ...
        bordered_qr = self.preview_service.generate_qr_code(
            data="Bordered QR",
            **border_options
        )
    ...
    def test_barcode_generation_options(self):
        ...
        for barcode_type in barcode_types:
            try:
                barcode = self.preview_service.generate_barcode(
                    data="123456789",
        ...
        text_barcode = self.preview_service.generate_barcode(
            data="C7442639",
            barcode_type="CODE128",
            include_text=True
        )
        ...
        sized_barcode = self.preview_service.generate_barcode(
            data="SIZE_TEST",
            barcode_type="CODE128",
            **size_options
        )
    ...
    async def test_label_printing_workflow(self):
        ...
        qr_result = await self.printer_service.print_part_qr_code(
            part=self.test_part,
            printer_id="label_test_printer"
        )
        ...
        name_result = await self.printer_service.print_part_name(
            part=self.test_part,
            printer_id="label_test_printer"
        )
        ...
        combined_result = await self.printer_service.print_qr_and_text(
            part=self.test_part,
            text="Custom Text",
            printer_config={"dpi": 300},
            label_data={"label_size": "62x29"}
        )
    ...
    def test_label_template_customization(self):
        ...
        rendered_template = self.preview_service.render_custom_template(
            ...
            data={
                "part_number": self.test_part.part_number,
                "part_name": self.test_part.part_name
            }
        )
        ...
        rendered_conditional = self.preview_service.render_custom_template(
            ...
            data={
                "part_number": self.test_part.part_number,
                "quantity": self.test_part.quantity
            }
        )
    ...
    def test_label_print_queue_management(self):
        ...
        queue_items = [
            {
                "type": "text",
                "content": "Queue Item 1",
                "label_size": "29x90",
                "priority": "normal"
            },
            {
                "type": "qr",
                "data": "https://example.com/item2",
                "label_size": "29x90",
                "priority": "high"
            },
            {
