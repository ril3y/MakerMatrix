...
class TestUserRepositoryNew:
    ...
    def test_create_user_success(self):
        ...
        test_role = RoleModel(name="test_role", description="Test Role", permissions=["read", "write"])
    ...
    def test_create_user_duplicate_username(self):
        ...
        # Create initial user
        session = self.test_db.get_session()
        existing_user = UserModel(username="duplicate", email="first@example.com", hashed_password="hash123")
    ...
    def test_create_user_duplicate_email(self):
        ...
        # Create initial user
        session = self.test_db.get_session()
        existing_user = UserModel(username="first", email="duplicate@example.com", hashed_password="hash123")
        session.add(existing_user)
        session.commit()
    ...
    def test_get_user_by_username_success(self):
        ...
        # Create user
        session = self.test_db.get_session()
        test_user = UserModel(username="findme", email="findme@example.com", hashed_password="hash123")
    ...
    def test_get_user_by_id_success(self):
        ...
        # Create user
        session = self.test_db.get_session()
        test_user = UserModel(username="testuser", email="test@example.com", hashed_password="hash123")
        session.add(test_user)
        session.commit()
    ...
    def test_update_user_success(self):
        ...
        # Create user
        session = self.test_db.get_session()
        test_user = UserModel(username="updateme", email="old@example.com", hashed_password="hash123")
        session.add(test_user)
        session.commit()
        user_id = test_user.id

        # Update user
        result = self.repo.update_user(user_id=user_id, email="new@example.com", is_active=False)
    ...
    def test_delete_user_success(self):
        ...
        # Create user
        session = self.test_db.get_session()
        test_user = UserModel(username="deleteme", email="delete@example.com", hashed_password="hash123")
        session.add(test_user)
        session.commit()
        user_id = test_user.id
    ...
    def test_create_role_success(self):
        ...
        result = self.repo.create_role(name="new_role", description="New Role", permissions=["read", "write", "delete"])
    ...
    def test_get_role_by_name_success(self):
        ...
        # Create role
        session = self.test_db.get_session()
        test_role = RoleModel(name="find_role", description="Find Me", permissions=["read"])
        session.add(test_role)
        session.commit()
