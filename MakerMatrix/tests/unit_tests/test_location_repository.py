...
class TestLocationRepositorySimple:
    ...
    def test_add_location_success(self):
        ...
        location_data = {"name": "Test Location", "description": "A test location", "location_type": "storage"}
    ...
    def test_add_location_with_invalid_parent_error(self):
        ...
        location_data = {"name": "Orphan Location", "description": "No parent", "parent_id": "nonexistent-parent-id"}
    ...
    def test_get_all_locations_success(self):
        ...
        for i in range(3):
            location_data = {"name": f"Location {i}", "description": f"Description {i}"}
            LocationRepository.add_location(session, location_data)
    ...
    def test_update_location_success(self):
        ...
        # Update location
        update_data = {"name": "Updated Name", "description": "Updated description", "location_type": "workbench"}
    ...
    def test_preview_delete_functionality(self):
        ...
        part = PartModel(part_name="Preview Part", part_number="PP001", quantity=1, location_id=parent.id)
        session.add(part)
        session.commit()
