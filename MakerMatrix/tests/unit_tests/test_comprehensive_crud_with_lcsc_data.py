...
class TestComprehensiveCRUDWithLCSCData:
    ...
    def test_load_lcsc_csv_data(self):
        ...
        expected_fields = ['lcsc_part_number', 'manufacturer_part_number', 'manufacturer', 
                          'package', 'description', 'rohs', 'order_qty', 'unit_price', 'order_price']
    ...
    def test_category_crud_operations(self):
        ...
        category_data = {
            'name': 'Capacitors',
            'description': 'Electronic capacitors and related components'
        }
    ...
    def test_parts_with_categories_relationship(self):
        ...
        capacitor_category = CategoryRepository.create_category(session, {
            'name': 'Capacitors',
            'description': 'Electronic capacitors and related components'
        })
        
        connector_category = CategoryRepository.create_category(session, {
            'name': 'Connectors',
            'description': 'Electronic connectors and cable assemblies'
        })
    ...
    def test_comprehensive_crud_workflow(self):
        ...
        category_data = {
            ...
            'description': 'Components for workflow testing'
        }
