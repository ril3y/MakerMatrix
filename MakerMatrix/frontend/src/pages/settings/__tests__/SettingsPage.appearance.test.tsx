...
describe('SettingsPage - Appearance Tab', () => {
  ...
  describe('Color Theme Section', () => {
    ...
    it('renders color theme section', () => {
      ...
      expect(screen.getByText('Choose a color theme that suits your preference')).toBeInTheDocument()
    })
  ...
  describe('Compact Mode Section', () => {
    ...
    it('renders compact mode section', () => {
      ...
      expect(screen.getByText('Reduce spacing and padding for more content density')).toBeInTheDocument()
    })
