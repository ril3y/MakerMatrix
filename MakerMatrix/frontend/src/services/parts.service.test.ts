...
describe('PartsService', () => {
  ...
  describe('createPart', () => {
    it('creates new part successfully', async () => {
      ...
      expect(apiClient.post).toHaveBeenCalledWith('/api/parts/add_part', expect.objectContaining({
        part_name: 'New Part',
        part_number: 'NP001',
        category_names: []
      }))
  ...
  describe('updatePart', () => {
    it('updates part successfully', async () => {
      ...
      expect(apiClient.put).toHaveBeenCalledWith('/api/parts/update_part/test-id', expect.objectContaining({
