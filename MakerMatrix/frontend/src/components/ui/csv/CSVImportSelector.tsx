  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card p-4">
        <h4 className="font-medium text-text-primary mb-4">Select Supplier</h4>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h5 className="font-medium text-text-primary">{parser.name}</h5>
                  <p className="text-sm text-text-secondary mt-1">{parser.description}</p>
                  {!parser.component && (
                    <p className="text-xs text-text-muted mt-2 italic">Coming soon</p>
                  )}
                </div>
              </div>
