...
class PrintSettings:
    def __init__(
        ...
        qr_scale: float = 0.95,     # QR code scale factor (0.95 = 95% of available height)
        qr_min_size_mm: float = 8.0,  # minimum QR code size in mm for phone scanning
        qr_max_margin_mm: float = 1.0  # maximum margin around QR code in mm
    ):
        self.margin = margin
        ...
        self.qr_min_size_mm = qr_min_size_mm
        self.qr_max_margin_mm = qr_max_margin_mm
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "qr_min_size_mm": self.qr_min_size_mm,
            "qr_max_margin_mm": self.qr_max_margin_mm
        }
