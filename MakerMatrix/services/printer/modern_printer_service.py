...
class ModernPrinterService:
    ...
    async def print_text_label(self, text: str, printer_id: Optional[str] = None, 
                              label_size: str = "62", copies: int = 1) -> PrintJobResult:
        """Print a text label."""
        printer = self.get_printer(printer_id)
    ...
    async def print_qr_and_text(self, part: PartModel, text: str, printer_config: Dict[str, Any], 
                               label_data: Dict[str, Any], printer_id: Optional[str] = None) -> PrintJobResult:
        ...
        try:
            ...
            print_settings = PrintSettings(
                label_size=int(label_data.get("label_width", 62)),
