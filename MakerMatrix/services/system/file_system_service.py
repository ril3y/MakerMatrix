...
class FileSystemService:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.allowed_image_extensions = config.get(
            "allowed_image_extensions", [".jpg", ".jpeg", ".png", ".gif", ".webp"]
        )
        self.allowed_datasheet_extensions = config.get(
    ...
    def save_file(self, content: bytes, file_path: str, overwrite: bool = False) -> Dict[str, Any]:
        ...
        try:
            ...
            if not self.ensure_directory_exists(directory):
                return {"success": False, "error": f"Failed to create directory: {directory}", "file_path": file_path}
    ...
    async def download_and_save_file(
        self, url: str, file_path: str, overwrite: bool = False, timeout: int = 30
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {"success": False, "error": str(e), "url": url, "file_path": file_path}
    ...
    def get_datasheet_file_path(self, supplier: str, part_number: str, file_extension: str = ".pdf") -> str:
        ...
        file_path = os.path.join(self.base_datasheet_path, safe_supplier, f"{safe_part_number}{file_extension}")
    ...
    def get_image_file_path(self, supplier: str, part_number: str, file_extension: str = ".jpg") -> str:
        ...
        file_path = os.path.join(self.base_image_path, safe_supplier, f"{safe_part_number}{file_extension}")
    ...
    def validate_file_path(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if ".." in normalized_path or normalized_path.startswith("/"):
                return {"valid": False, "error": "Path traversal attempt detected", "path": file_path}
            ...
            if len(normalized_path) > 255:
                return {"valid": False, "error": "Path too long (max 255 characters)", "path": file_path}

            return {"valid": True, "normalized_path": normalized_path, "file_extension": file_extension}
    ...
    def delete_file(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            if not os.path.exists(file_path):
                return {"success": False, "error": f"File does not exist: {file_path}", "file_path": file_path}
