...
class EnrichmentProgressTracker:
    ...
    def start_tracking(self, total_steps: int, message: str = "Starting enrichment") -> None:
        ...
        self._emit_event(
            ...
            {"message": message, "total_steps": total_steps, "start_time": self.start_time.isoformat()},
        )
    ...
    def report_success(
        self, message: str = "Operation completed successfully", result_data: Dict[str, Any] = None
    ) -> None:
        """
    ...
    def report_error(self, error: Exception, message: str = "", context: Dict[str, Any] = None) -> None:
        """
        Report an error.
    ...
    def cancel(self, message: str = "Operation cancelled") -> None:
        ...
        event_data = {"message": message, "end_time": self.end_time.isoformat(), "duration": self._calculate_duration()}
    ...
    def get_detailed_status(self) -> Dict[str, Any]:
        ...
        status.update({"events": self.events, "errors": self.errors, "warnings": self.warnings})
        return status
...
class MultiStepProgressTracker:
    ...
    def start_step(self, step_key: str, step_name: str, sub_steps: int = 1) -> EnrichmentProgressTracker:
        ...
        self.main_tracker.update_progress(
            self.main_tracker.current_step + 1, f"Starting {step_name}", {"current_step_key": step_key}
        )
    ...
    def complete_step(self, step_key: str, message: str = "Step completed") -> None:
        ...
        if step_key in self.step_trackers:
            ...
            # Update main tracker
            self.main_tracker.update_progress(
                self.main_tracker.current_step, f"Completed {message}", {"completed_step_key": step_key}
            )
    ...
    def get_overall_status(self) -> Dict[str, Any]:
        ...
        status["steps"] = {key: tracker.get_current_status() for key, tracker in self.step_trackers.items()}
        return status
