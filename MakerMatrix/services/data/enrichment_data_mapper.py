...
class EnrichmentDataMapper:
    ...
    def convert_enrichment_to_part_search_result(
        ...
        try:
            ...
            return PartSearchResult(
                ...
                manufacturer_part_number=extracted_data.get('manufacturer_part_number') or part.manufacturer_part_number,
    ...
    def merge_enrichment_results(self, existing_data: Dict[str, Any], new_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            simple_fields = ['datasheet_url', 'image_url', 'pricing', 'stock_quantity', 
                           'manufacturer', 'manufacturer_part_number', 'description', 'category']
