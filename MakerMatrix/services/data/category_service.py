        ...
        try:
            ...
            with self.get_session() as session:
                ...
                return self.success_response(
                    f"{self.entity_name} '{category_data.name}' created successfully", cat_dict
                )
    ...
    def get_category(self, category_id: Optional[str] = None, name: Optional[str] = None) -> ServiceResponse[dict]:
        ...
        try:
            ...
            with self.get_session() as session:
                ...
                return self.success_response(f"{self.entity_name} '{category.name}' retrieved successfully", cat_dict)
    ...
    def remove_category(self, id: Optional[str] = None, name: Optional[str] = None) -> ServiceResponse[dict]:
        ...
        try:
            ...
            with self.get_session() as session:
                ...
                return self.success_response(f"{self.entity_name} '{rm_cat.name}' removed successfully", cat_dict)
    ...
    def get_all_categories(self) -> ServiceResponse[dict]:
        ...
        try:
            ...
            with self.get_session() as session:
                ...
                return self.success_response("All categories retrieved successfully", {"categories": categories_list})
    ...
    def update_category(self, category_id: str, category_update) -> ServiceResponse[dict]:
        ...
        try:
            ...
            with self.get_session() as session:
                ...
                return self.success_response(
                    f"{self.entity_name} '{updated_category.name}' updated successfully", cat_dict
                )
